...
const ScoopOptions = (props: propType) => {
    ...
    const handleChange = (e: any) => {
        ...
        updateItemCount(props.name, newValue, "scoops");
    };

    return (
        <Col xs={12} sm={6} md={4} lg={3} style={{ textAlign: "center" }}>
            <img style={{ width: "75%" }} src={`http://localhost:3030/${props.imagePath}`} alt={`${props.name} scoop`} />
        <Form.Group controlId={`${props.name}-count`} as={Row} style={{ marginTop: "10px" }} >
